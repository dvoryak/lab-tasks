...
public class NonBlockingQueue<E> {
    ...
    private Node<E> dammy = new Node<>(null,null);
    private AtomicReference<Node<E>> head = new AtomicReference<>(dammy);
    private AtomicReference<Node<E>> tail = new AtomicReference<>(dammy);
